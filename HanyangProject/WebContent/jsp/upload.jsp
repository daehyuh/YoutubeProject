  ...
  <div class="header">
		...
		<div class="header__search">
			<form action="/search" method="post">
				<input type="text" name="searchBox" placeholder="검색" />
				<button onclick="location.href='/jsp/search.jsp?';">
    ...
    <div class="upload">
      ...
      <form method="post" enctype="multipart/form-data" action="/FileUpload">
        <table class="upload-table">
          ...
          <tr>
            <td>영상 이름</td>
            <td><input type="text" name="VIDEO_NAME" id="VIDEO_NAME" size="100"></td>
          </tr>
			
          <tr>
            <td>영상 소개</td>
            <td>
              <textarea name="VIDEO_INTRO" id="VIDEO_INTRO" cols="120" rows="30"></textarea>
            </td>
          </tr>
